...
class SpringframeworkInitialApplicationTests {
    ...
    void insertarEmpleado() {
        ...
        empleado.setNombre("Juan Diego ");
        empleado.setSalario(new BigDecimal("7000.00"));
    ...
    void actualizarEmpleado() {
        ...
        empleado.setNombre("Juan Diego Gatica Capa");
        ...
        assertThat(empleadoActualizado.getNombre()).isEqualTo("Juan Diego Gatica Capa");
    }
